...
const ADMIN_BILINGUAL={
  'SECURE ADMIN ACCESS':'SECURE ADMIN ACCESS / 安全后台',
  'Sign in to manage the website':'Sign in to manage the website / 登录管理网站',
  'Use your authorised NANOFIX administrator account.':'Use your authorised NANOFIX administrator account. / 请使用已授权的 NANOFIX 管理员账号。',
  'Email':'Email / 邮箱','Password':'Password / 密码','Sign in':'Sign in / 登录','Signing in…':'Signing in… / 正在登录…',
  '← Back to website':'← Back to website / 返回网站','ADMIN WORKSPACE':'ADMIN WORKSPACE / 管理后台','Workspace':'Workspace / 工作区',
  'Dashboard':'Dashboard / 控制面板','Page content':'Page content / 页面内容','Services':'Services / 服务项目','FAQ & reviews':'FAQ & reviews / 常见问题与评论',
  'Media library':'Media library / 媒体库','Form inbox':'Form inbox / 表单收件箱','Settings':'Settings / 设置','Public website':'Public website / 网站前台',
  'Open nanofixac.com ↗':'Open nanofixac.com ↗ / 打开 nanofixac.com ↗','Supabase connected':'Supabase connected / Supabase 已连接',
  'Sign out':'Sign out / 退出登录','Manage content, enquiries and publishing-ready updates':'Manage content, enquiries and publishing-ready updates / 管理内容、询盘和可发布更新',
  'Good afternoon':'Good afternoon / 下午好','A focused control centre for Singapore high-temperature steam aircon cleaning.':'A focused control centre for Singapore high-temperature steam aircon cleaning. / 新加坡高温蒸汽空调清洗的集中管理中心。',
  'Total enquiries':'Total enquiries / 询盘总数','New to follow up':'New to follow up / 待跟进','Published pages':'Published pages / 已发布页面','Review drafts':'Review drafts / 评论草稿',
  'Recent enquiries':'Recent enquiries / 最新询盘','View inbox':'View inbox / 查看收件箱','Quick actions':'Quick actions / 快捷操作',
  'Edit homepage hero':'Edit homepage hero / 编辑首页主视觉','Update headline, intro and SEO description':'Update headline, intro and SEO description / 更新标题、简介和 SEO 描述',
  'Review FAQ content':'Review FAQ content / 检查常见问题内容','Manage search-ready questions and answers':'Manage search-ready questions and answers / 管理适合搜索的问题与答案',
  'Export workspace data':'Export workspace data / 导出工作区数据','Download a JSON backup of local changes':'Download a JSON backup of local changes / 下载本地修改的 JSON 备份',
  'Open':'Open / 打开','Export':'Export / 导出','CMS':'CMS / 内容管理系统','Page content':'Page content / 页面内容',
  'Edit supported SEO and hero fields. Publish English or Chinese hero and SEO fields directly to Supabase.':'Edit supported SEO and hero fields. Publish English or Chinese hero and SEO fields directly to Supabase. / 编辑支持的 SEO 和主视觉字段，直接向 Supabase 发布英文或中文内容。',
  'How this works':'How this works / 使用说明','Choose a language, save the page and refresh the public page to view the published Supabase content.':'Choose a language, save the page and refresh the public page to view the published Supabase content. / 选择语言并保存页面，然后刷新网站前台查看已发布的 Supabase 内容。',
  'Pages':'Pages / 页面','Homepage':'Homepage / 首页','Page language':'Page language / 页面语言','Hero title':'Hero title / 主视觉标题','Hero introduction':'Hero introduction / 主视觉简介','Meta description':'Meta description / Meta 描述',
